...
ras_specs = sh_modules.getRasterDims(stlink_loc)
#-----------------------------------------------------------------------------------------------------
...
sh_modules.getrasprj(reachmap_name,fdrmap_name,mydir)  #assign raster prj from input fdr raster
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.getffs(db_name, db_usr_name, db_pw, db_schema, mydir, ftable_name, fcsv_name)
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.getaggseq(db_name, db_usr_name, db_pw, db_schema, mydir, ftable_name, seqtable_name, lcsv_name, tlentab_name)
...
sh_modules.getrasprj(sh_ls_ras_name,fdrmap_name,mydir)  #assign raster prj from input fdr raster
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.ras2poly(sh_ls_ras_name, latshedpoly_name)
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.loadshppgis(db_name, db_usr_name, db_pw, db_schema, mydir, pgsqlbinpath, latshedpoly_name, geom_srid)
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.calc_ls_area(db_name, db_usr_name, db_pw, db_schema, mydir, pgsqlbinpath, latshedpoly_name, geom_srid, seqtable_name)
...
print start_time
outlogf.write(str(start_time) + '\n')
sh_modules.make_j_specs(db_name, db_usr_name, db_pw, db_schema, mydir, pgsqlbinpath, seqtable_name, geom_srid, j_tab_name)
